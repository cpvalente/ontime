...
export async function getProject(_req: Request, res: Response<ProjectData>) {
  res.json(DataProvider.getProjectData());
}

export async function postProject(req: Request, res: Response<ProjectData | ErrorResponse>) {
 ...
 */
export async function uploadProjectFile(req: Request, res: Response<MessageResponse | ErrorResponse>) {
  if (!req.file) {
