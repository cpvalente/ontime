...
export function createPatch(originalEvent: OntimeEvent, patchEvent: Partial<OntimeEvent>): OntimeEvent {
  ...
  return {
    ...
    delay: originalEvent.delay, // is always regenerated by the cache
    dayOffset: originalEvent.dayOffset, // is always regenerated by the cache
    gap: originalEvent.gap, // is always regenerated by the cache
