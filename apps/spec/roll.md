...
Finish actions are ignored in roll mode, unless the event has `breakRoll` enabled — in which case roll mode stops and the event's end action (None/LoadNext/PlayNext) applies normally
