import { MessageState, OntimeEvent, ProjectData, Runtime, Settings, SimpleTimerState, ViewSettings } from 'ontime-types';
...
export default function Studio(props: StudioProps) {
  const { eventNow, general, isMirrored, message, time, runtime, onAir, auxTimer, settings, viewSettings } = props;
