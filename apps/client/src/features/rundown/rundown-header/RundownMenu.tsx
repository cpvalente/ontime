...
export default function RundownMenu() {
  ...
  const { deleteAllEvents, toggleFreezeEvents } = useEventAction();
  ...
  return (
    <div className={style.controls}>
      <Switch variant='ontime' isChecked={frozen} onChange={() => toggleFreezeEvents(!frozen)}>
        Freeze
      </Switch>
      ...
      <div>
        <Button
          ...
          onClick={onOpen}
          color='#FA5656'
          isDisabled={appMode !== 'edit' || frozen}
        >
          Clear rundown
        </Button>
