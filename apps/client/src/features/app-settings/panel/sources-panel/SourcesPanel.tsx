          ...
          {showInput && (
            <>
              ...
              <div className={style.uploadSection}>
                <div>
                  <Button variant='ontime-filled' size='sm' onClick={handleUpload} loading={hasFile === 'loading'}>
                    <IoDownloadOutline /> Import from spreadsheet
                  </Button>
                  <Panel.Description>Accepts .xlsx files</Panel.Description>
                </div>
                <div>
                  <Button variant='ontime-filled' size='sm' onClick={openGSheetFlow} disabled={hasFile !== 'none'}>
                    <IoCloudOutline /> Synchronise with Google
                  </Button>
